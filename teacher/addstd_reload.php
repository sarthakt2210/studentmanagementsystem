...
<body>
                        ...
                        <div class="column_grid">
                            <div class="firstcolumn">
                                ...
                                <div class="input-div focus">
                                    ...
                                    <div>
                                    <h5>ADMISSION ID</h5>
                                    <input type="text" class="adid" name='adid' value="<?php echo $adid?>" required>
                                    </div>
                                </div>
                                <div class="input-div focus">
                                    <div class="i">
                                    ...
                                    <input type="date" class="dob" name='dob'  format="dd-mm-yyyy"  value="<?php echo $dob?>"required>
                                        <!-- <input type="text" style="width:200px;background-color:#aed6f1;" class="form-control" id="usr1" name="event_date" placeholder="YYYY-MM-DD" autocomplete="off" > -->
                                    </div>
                                ...
                                <div class="input-div focus">
                                    ...
                                    <div>
                                    <h5>MOTHER NAME</h5>
                                    <input type="text" class="mname" name='mname' value="<?php echo $mname?>" required>
                                    </div>
                                </div>
                                <div class="input-div focus">
                                    <div class="i">
                                    ...
                                    <div>
                                    <h5>FATHER NAME</h5>
                                    <input type="text" class="fname" name='fname' value="<?php echo $fname?>" required>
                                    </div>
                                </div>
                                <div class="input-div focus">
                                    <div class="i">
    ...
    <!-- </div> -->
        ...
        if(isset($_SESSION['messageprofile'])){
            ?><script>swal("PROFILE NOT FOUND", "Please provide profile photo", "error");</script>
            <?php
            unset($_SESSION['messageprofile']);
        }elseif(isset($_SESSION['invalid_ext'])){
                ?><script>swal("INVALID FILE ", "Extension: 'jpg' 'png' 'jpeg' are valid !! Please enter a valid file.", "error");</script>
                <?php
                unset($_SESSION['invalid_ext']);
        }elseif(isset($_SESSION['already_exist_adid'])){
            ?><script>swal("ADMISSION ID '<?php echo $_SESSION['already_exist_adid'] ?>' ALREADY EXISTS!", "Please Change the admission id.", "error");</script>
            <?php
            unset($_SESSION['already_exist_adid']);
