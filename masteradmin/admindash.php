        ...
        <div class="container_admin">
            ...
            <div class="admin-trans">
                ...
                <div class="container">
                    ...
                    <div class="box" id="adminmanage">
                        <div class="icon">Manage Admins</div>
                        <div class="content">
                            <h3><img src="./img/admin_manage_dash.svg" alt="" class="mana" srcset=""></h3>
                            <p>Manage Admins of your Institution. <br>!Add !Update !Delete</p>
                        </div>
                    </div>
                    <div class="box" id="manage_teach">
                        ...
                        <div class="content">
                            ...
                            <p>You can manage Teachers <br>!Add !Update !Delete</p>
                        </div>
                    </div>
                </div>
            </div>
