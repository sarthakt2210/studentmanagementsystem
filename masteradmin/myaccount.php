...
<body>
    ...
    <div class="admin_cont">
        ...
        <form class="change" action="admin_pass_change.php" method="post">
            <div class="input-div">
                ...
                <div>
                <h5>NEW PASSWORD</h5>
                <input type="text" class="password" name='password' required autocomplete="off">
                </div>
            </div>
            <input type="submit" class='btn' value='Change Password'>
        </form>
        <form class="changename" action="admin_name_change.php" method="post">
            <div class="input-div">
                <div class="i">
                ...
                <div>
                <h5>NEW NAME</h5>
                <input type="text" class="password" name='newname' required autocomplete="off">
                </div>
            </div>
            <input type="submit" class='btn' value='Update Name'>
        </form>
    </div>
    ...
    if(isset($_SESSION['admin_no_change_in_name'])){
        ?><script>swal("<?php echo $_SESSION['user'];?> NOT UPDATED", "NO CHANGE IN NAME.", "warning");</script>
        <?php
        unset($_SESSION['admin_no_change_in_name']);
    }
    if(isset($_SESSION['admin_name_change'])){
        ?><script>swal("<?php echo $_SESSION['user'];?> UPDATED", "NAME CHANGE UPDATED", "success");</script>
        <?php
        unset($_SESSION['admin_name_change']);
    }
    ?>
